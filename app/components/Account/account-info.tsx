  ...
  return (
    <div className="flex flex-col gap-[12px] py-[8px]">
      ...
      <div className="flex justify-between items-center gap-[4px]">
        <button
          className="flex w-[100%] h-[50px] justify-center items-center cursor-pointer text-[14px] leading-[20px] gap-[4px] bg-gray-100 rounded-[8px]"
