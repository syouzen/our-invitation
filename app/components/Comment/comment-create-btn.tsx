    ...
    <Dialog
      ...
      trigger={
        <button
          disabled
          className={cn(
            'flex w-fit px-[12px] py-[6px] border-none rounded-full bg-gray-100 justify-center items-center gap-[5px] text-[12px] leading-[18px] cursor-pointer transition-colors',
