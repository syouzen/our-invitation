...
export default function IconLink(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <g>
        <path
          d="M0.043,245.197c0.6,10.1,7.3,18.6,17,21.5l179.6,54.3l6.6,123.8c0.3,4.9,3.6,9.2,8.3,10.8c1.3,0.5,2.7,0.7,4,0.7
